...
if(get_theme_mod('enable_banner_section')==true){
	...
	?>
	<div class="wrapper banner-wrapper banner-layout-3 <?php echo esc_attr($banner_horizontal_alignment).' '.esc_attr($banner_vertical_alignment);?>">
		<div class="container"> 
			<div class="banner-contents col-md-6">
			...
			<?php } ?>
				...
				<div class="banner-image col-md-6">
					<img class="banner-img" src="<?php echo esc_url($banner_hero_img);?>" />
				</div>
			<?php } ?>
