...
if(get_theme_mod('enable_services_section') == true){
	...
	?>
	<div class="wraper service-wraper service-layout-2 section-animate <?php echo esc_attr($text_align_class);?>">
		<div class="container">
			 <div class="col-md-5 section-header">
				...
				<div class="col-md-7">
					<div class="services-holder">
						...
						if(!empty($mularx_service_page) && $mularx_service_page != 'None' ){
							...
							$mualrx_query = new WP_Query( $args );
							if ( $mualrx_query->have_posts() ) :
								while ( $mualrx_query->have_posts() ) : $mualrx_query->the_post();
									...
									<a href="<?php the_permalink();?>" >
										<?php echo '<h4 class="service-title">'; the_title(); echo '</h4>'; ?>
									</a>
									<?php echo '<p class="service-excerpt">'.  wp_kses_post(mularx_excerpt(20)) .'</p>'; ?>
